            ...
            <div class="flex-1 py-3">
                @if ($project)
                    ...
                    @foreach ([
                        ...
                        ['label' => 'Clusters', 'route' => 'project.clusters'],
        ...
        @if ($project)
            <nav class="md:hidden fixed bottom-0 inset-x-0 h-16 bg-bg border-t border-border z-50 flex items-center justify-around">
                @foreach ([
                    ...
                    ['label' => 'Clusters', 'route' => 'project.clusters', 'icon' => 'M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zm0 8a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zm12 0a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z'],
